...
(function(root) {
  ...
  const RAW_CANONICAL_GAMES = [
    ...
    },
    {
      ...
      durationText: "35 min",
      xp: 100,
      skills: ["CLIL Human Biology", "Reading Comprehension", "Speaking & Presentation", "Functional Modals (helps us / use to)"],
    ...
    },
    {
      ...
      durationText: "30 min",
      xp: 150,
      skills: ["CLIL Clean Energy", "Engineering Design Cycle", "Oral Debrief & Presentation", "Functional Modals (uses [Energy] to [Verb])"],
    ...
    },
    {
      ...
      description: "High-energy CLIL science and movement game demonstrating human metabolic energy. Kids dance and freeze to compare muscle stillness (0% energy) with the 20% fuel their brain burns while thinking!",
      type: "game",
      category: "CLIL & STEM Games",
      ...
      durationText: "25 min",
      xp: 150,
      skills: ["CLIL Human Biology", "Mental Arithmetic", "Sensory & Lobe Vocabulary", "Listening & Kinesthetic Response"],
    ...
    },
    {
      ...
      durationText: "35 min",
      xp: 150,
      skills: ["Invention Vocabulary", "Infinitive of Purpose (to + verb)", "Compound Problem Solving", "60-Second Timed Pitching"],
    ...
    },
    {
      ...
      category: "Literature & Reading Quests",
      level: "A1 / A2 / B1",
      age: "8–12",
      grade: "Grade 3–5",
      duration: 45,
      xp: 200,
      skills: ["Differentiated Reading Comprehension", "Creative Writing & Alternate Endings", "Public Speaking & Spoken Summaries", "Drama & Character Portrayal"],
      topics: ["Alice in Wonderland Differentiated Quests", "Vocabulary", "Character Analysis", "Scene Retelling", "Dramatic Acting"],
  ...
  const DEFAULT_HOMEWORK_QUESTS = [
    ...
    // =========================================================================
    // 📘 Alice in Wonderland: Discrete Homework XP Tasks
    // =========================================================================
    // Base Participation
    {
      id: 'hw-alice-checkin',
      code: 'HW-ALICE-000',
      title: 'Alice in Wonderland: Reading Check-In',
      description: 'Submit completed base log / reading check-in participation confirmation.',
      subject: 'Participation',
      skill: 'Reading Check-In',
      ...
      resources: [
        { id: 'res-alice-story-000', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Log today\'s reading time in your reading passport',
        '2. Confirm which chapter of Alice in Wonderland you completed',
        '3. Submit for participation verification'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
      companionImage: 'assets/homework/alice-xp-challenges-poster.jpg',
      submittedCount: 0,
      archived: false,
      submissions: {}
    },
    // Tier 1: Level 1 — Get Started!
    {
      id: 'hw-alice-vocab10',
      code: 'HW-ALICE-101',
      title: 'Alice in Wonderland: Learn 10 New Words & Meanings',
      description: 'Find, define, and practice 10 new vocabulary words from Alice in Wonderland.',
      subject: 'Vocabulary',
      skill: 'Vocabulary',
      category: 'Vocabulary',
      cefrLevel: 'A1',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 5,
      optionalChallengeDesc: 'Draw mini sketch icons next to each word definition!',
      resources: [
        { id: 'res-alice-story-101', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Select 10 unfamiliar words from the chapter',
        '2. Look up the meaning and write a clear definition',
    ...
    },
    {
      ...
      code: 'HW-ALICE-102',
      title: 'Alice in Wonderland: Favorite Character + 3 Reasons',
      description: 'Choose your favorite Wonderland character and state 3 detailed reasons why.',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 5,
      optionalChallengeDesc: 'Quote a funny line spoken by your favorite character!',
      resources: [
        { id: 'res-alice-story-102', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Choose a character (Alice, White Rabbit, Cheshire Cat, Mad Hatter, etc.)',
        '2. Write or record 3 distinct reasons why they are your favorite',
        '3. Use opinion starters: "In my opinion...", "I like them because..."'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      id: 'hw-alice-draw',
      code: 'HW-ALICE-103',
      title: 'Alice in Wonderland: Draw a Scene/Character & Explain',
      description: 'Draw a colorful scene or character from Wonderland and provide a written or spoken explanation.',
      subject: 'Creative',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 5,
      optionalChallengeDesc: 'Add 5 descriptive labels pointing to details in your drawing!',
      resources: [
        { id: 'res-alice-story-103', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Sketch a scene (e.g. falling down the rabbit hole, the tea party)',
        '2. Add color and vibrant details',
        '3. Write 3-4 sentences explaining what is happening in the drawing'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      id: 'hw-alice-comp5',
      code: 'HW-ALICE-104',
      title: 'Alice in Wonderland: Answer 5 Comprehension Questions',
      description: 'Answer 5 key comprehension questions using complete English sentences.',
      subject: 'Reading',
      skill: 'Reading Comprehension',
      category: 'Reading',
      cefrLevel: 'A1',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 5,
      optionalChallengeDesc: 'Write 1 extra quiz question for a classmate to answer!',
      resources: [
        { id: 'res-alice-story-104', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Read the 5 comprehension questions carefully',
        '2. Locate evidence directly in the story text',
        '3. Formulate answers using complete sentences'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    // Tier 2: Level 2 — Go Deeper!
    {
      id: 'hw-alice-vocab25',
      code: 'HW-ALICE-201',
      title: 'Alice in Wonderland: Learn 25 Words (10 Used in Sentences)',
      description: 'Master 25 story vocabulary words and compose original sentences for at least 10 of them.',
      subject: 'Vocabulary',
      ...
      level: 2,
      optionalChallenge: true,
      optionalChallengeXp: 10,
      optionalChallengeDesc: 'Group your 25 words into categories: nouns, action verbs, and adjectives!',
      resources: [
        { id: 'res-alice-story-201', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Compile 25 vocabulary words from the book',
        '2. Check definitions and parts of speech',
        '3. Write 10 original compound or complex sentences using 10 selected words'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      ...
      code: 'HW-ALICE-202',
      title: 'Alice in Wonderland: 2-Minute Character Talk (Actions & Role)',
      description: 'Deliver a structured 2-minute oral talk detailing a character\'s personality, choices, and role in Wonderland.',
      subject: 'Speaking',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 10,
      optionalChallengeDesc: 'Wear a costume piece or prop matching your character during your presentation!',
      resources: [
        { id: 'res-alice-story-202', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Choose a character and brainstorm their actions, emotions, and motivation',
        '2. Structure your talk: Introduction (30s), Key Actions (60s), Reflection (30s)',
        '3. Present live in class or record and submit an audio/video clip'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      id: 'hw-alice-retell',
      code: 'HW-ALICE-203',
      title: 'Alice in Wonderland: Retell One Key Scene (Without Reading)',
      description: 'Retell a key dramatic scene from memory without reading from notes, using expressive voice and time transitions.',
      subject: 'Speaking',
      skill: 'Story Retelling',
      category: 'Speaking',
      cefrLevel: 'A2',
      classId: 'all',
      className: 'All Classes',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 10,
      optionalChallengeDesc: 'Include 4 sound effects or vocal character changes while retelling!',
      resources: [
        { id: 'res-alice-story-203', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Pick one memorable scene (e.g. Falling Down the Well, The Mad Tea-Party, Queen\'s Croquet)',
        '2. Rehearse the events using First, Next, Then, Suddenly, and Finally',
        '3. Retell fluently without reading from a paper'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      ...
      code: 'HW-ALICE-204',
      title: 'Alice in Wonderland: Write an Alternate Ending (100–150 Words)',
      description: 'Invent and write a creative alternate resolution for Alice\'s adventure in Wonderland.',
      subject: 'Writing',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 10,
      optionalChallengeDesc: 'Include a surprise twist involving the Cheshire Cat\'s grin!',
      resources: [
        { id: 'res-alice-story-204', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Imagine: What if Alice did not wake up by the river bank yet?',
        '2. Draft a 100–150 word new ending with descriptive adjectives and past tense verbs',
        '3. Proofread for punctuation and spelling before submitting'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    // Tier 3: Level 3 — Big Challenge!
    {
      ...
      code: 'HW-ALICE-301',
      title: 'Alice in Wonderland: Compare Two Characters in Detail',
      description: 'Write an analytical comparison between two contrasting characters in Wonderland.',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 15,
      optionalChallengeDesc: 'Create a Venn diagram illustrating their shared traits and differences!',
      resources: [
        { id: 'res-alice-story-301', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Choose two contrasting characters (e.g. Alice vs. Queen of Hearts, or Mad Hatter vs. White Rabbit)',
        '2. Compare their personalities, behavior, and how they react to rules',
        '3. Write 2 structured paragraphs using connectors of contrast (however, whereas, on the other hand)'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      id: 'hw-alice-journey',
      code: 'HW-ALICE-302',
      title: 'Alice in Wonderland: Explain Alice’s Journey & Character Arc',
      description: 'Explain how Alice transforms from a confused outsider into a courageous, independent thinker.',
      subject: 'Critical Thinking',
      ...
      optionalChallenge: true,
      optionalChallengeXp: 15,
      optionalChallengeDesc: 'Highlight the exact moment in the trial where Alice stands up for herself!',
      resources: [
        { id: 'res-alice-story-302', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Analyze Alice at the beginning: bored, impulsive, confused by Wonderland rules',
        '2. Identify turning points: standing her ground at the tea party and confronting the Queen',
        '3. Conclude with a reflection on how challenges help learners grow in real life'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      id: 'hw-alice-act-out',
      code: 'HW-ALICE-303',
      title: 'Alice in Wonderland: Act Out a Scene (Partner/Group Video)',
      description: 'Collaborate with a partner or group to rehearse, record, and submit a dramatic scene reenactment.',
      subject: 'Speaking/Drama',
      skill: 'Dramatic Performance',
      ...
      level: 3,
      optionalChallenge: true,
      optionalChallengeXp: 20,
      optionalChallengeDesc: 'Design hand-drawn props and include background music in your video!',
      resources: [
        { id: 'res-alice-story-303', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Select a dramatic scene with dialogue (e.g. Advice from a Caterpillar, The Tea Party, The Trial)',
        '2. Assign roles and memorize your speaking lines',
        '3. Rehearse with gestures and facial expressions, then record or present live'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
    ...
    },
    {
      ...
      code: 'HW-ALICE-304',
      title: 'Alice in Wonderland: Full Story Spoken Summary (5–7 Minutes)',
      description: 'Deliver an extensive 5–7 minute comprehensive spoken summary of the entire Alice in Wonderland adventure.',
      subject: 'Speaking/Mastery',
      skill: 'Advanced Spoken Fluency',
      ...
      level: 3,
      optionalChallenge: true,
      optionalChallengeXp: 25,
      optionalChallengeDesc: 'Use a storyboard timeline with chapter illustrations during your oral delivery!',
      resources: [
        { id: 'res-alice-story-304', type: 'game', title: "Alice's Reading Quest", url: 'alice-quest' }
      ],
      instructions: [
        '1. Prepare an outline covering Exposition, Rising Action, Climax, and Resolution',
        '2. Use advanced sequence transitions and academic vocabulary',
        '3. Deliver smoothly for 5 to 7 minutes with minimal pause and strong vocal clarity'
      ],
      status: 'ACTIVE',
      published: true,
      thumbnail: 'assets/homework/alice-xp-challenges-poster.jpg',
  ...
  "student-4b-303": {
    ...
    "petName": "İlay",
    "monsterName": "Emberwing",
    "baseColor": "orange",
    "element": "ember",
    "highestUnlockedLevel": 4,
    "lastCelebratedLevel": 4,
    "isHatched": true,
    "hatchDate": "Sep 15, 2026",
    "equipped": {
      "body": "body-orange",
      "eyes": "default",
      "mouth": "mouth-smile",
    ...
    "unlockedItems": ["horns-dragon", "wings-dragon"],
    "evolutionHistory": [
      {
      ...
      {
        "id": "ev-student-4b-303-2",
        "date": "Sep 8, 2026",
        "type": "cracking",
        "title": "Egg Cracked!",
        "detail": "Egg began cracking with fiery ember energy."
      },
      {
        "id": "ev-student-4b-303-3",
        "date": "Sep 15, 2026",
        "type": "hatch",
        "title": "Emberwing Hatched!",
        "detail": "Hatched into Baby Emberwing Monster."
      },
      {
        "id": "ev-student-4b-303-4",
        "date": "Sep 20, 2026",
        "type": "evolution",
        "title": "Evolved to Growing Monster!",
        "detail": "Emberwing evolved into Level 4 Growing Monster with fiery wing-sprouts."
      }
    ]
  },
  "student-4b-305": {
    ...
    return {
      ...
      students: [
        ...
        },
        {
          ...
          xp: 520,
          level: 4,
          stageName: 'Level 4 - Growing Monster',
          equippedMonster: 'Growing Monster',
          monsterAvatar: 'monsters/emberwing-stage2.webp',
          element: 'ember',
          isEgg: false,
          streakDays: 4,
          archived: false,
      ...
      quizzes: [
        {
          id: "quiz-unit1-wonderland-brain",
          title: "🍄 Unit 1 Master Quest: Wonderland & Brain Lab",
          subtitle: "Diagnostic Progress Check & Mad Tea Party Priority Qualifier",
          type: "diagnostic-quiz",
          section: "quizzes-and-tests",
          category: "Unit Progress Checks",
          subject: "Literacy & CLIL Science",
          curriculumRef: "Global Readings 3 • Unit 1 (pp. 8–23)",
          grade: "Grade 4",
          classTarget: "Grade 4A",
          targetCefr: "A1+",
          skill: "Literacy & CLIL Science",
          durationMinutes: 25,
          scoring: {
            baseXP: 100,
            bonusXP: 20,
          ...
          stations: [
            {
              ...
              type: "Visual Recognition & Phonics",
              maxPoints: 30,
              tasks: [
                { id: "t1_skim", name: "10-Second Skim & Scan Radar", xp: 10 },
                { id: "t2_sel", name: "SEL Emotion Scanner", xp: 10 },
                { id: "t3_phonics", name: "Final -er Phonics Lock", xp: 10 }
              ]
            },
            {
              id: "vault-2-silver",
              name: "Level 2: Silver Vault",
              type: "Sequencing & Brain Anatomy",
              maxPoints: 40,
              tasks: [
                { id: "t4_sequence", name: "Alice Down-the-Hole Storyboard", xp: 20 },
                { id: "t5_lobes", name: "4-Lobe Brain Diagnostic Console", xp: 20 }
              ]
            },
            {
              id: "vault-3-gold",
              name: "Level 3: Gold Vault",
              type: "Analysis & Cause/Effect",
              maxPoints: 30,
              tasks: [
                { id: "t6_crates", name: "Why We Read Dual Crate Sort", xp: 15 },
                { id: "t7_cause_effect", name: "Cause & Effect Detective", xp: 15 }
              ]
            },
            {
              id: "vault-4-diamond",
              ...
              maxPoints: 20,
              tasks: [
                { id: "t8_canvas", name: "Neural Drafting Canvas & Reflection", xp: 10, bonusXP: 20 },
                { id: "t9_podium", name: "Wonderland Draft Teleprompter Claim", xp: 0, unlocksDraft: true }
              ]
            }
          ],
          questions: [
            { id: "t1_skim", question: "Task 1: 10-Second Skim & Scan Radar", xp: 10 },
            { id: "t2_sel", question: "Task 2: SEL Emotion Scanner", xp: 10 },
            { id: "t3_phonics", question: "Task 3: Final -er Phonics Lock", xp: 10 },
            { id: "t4_sequence", question: "Task 4: Alice Down-the-Hole Storyboard", xp: 20 },
            { id: "t5_lobes", question: "Task 5: 4-Lobe Brain Diagnostic Console", xp: 20 },
            { id: "t6_crates", question: "Task 6: Why We Read Dual Crate Sort", xp: 15 },
            { id: "t7_cause_effect", question: "Task 7: Cause & Effect Detective", xp: 15 },
            { id: "t8_canvas", question: "Task 8: Neural Drafting Canvas & Teleprompter Claim", xp: 20 }
          ],
          routes: {
      ...
      xpTransactions: [
        {
          id: 'xp-init-student-4b-303-alice-challenge',
          studentId: 'student-4b-303',
          amount: 200,
          points: 200,
          xpAmount: 200,
          xp: 200,
          reason: 'Alice in Wonderland: HW-ALICE-303 Creative Ending (+200 XP)',
          category: 'positive',
          icon: '⭐',
          date: 'September 2026',
          timestamp: '2026-09-18T10:00:00.000Z',
          source: 'homework',
          sourceId: 'hw-alice-303',
          classId: 'class-4b',
          status: 'active'
        },
        {
          id: 'xp-init-student-4b-303-nasa-mission',
          studentId: 'student-4b-303',
          amount: 150,
          points: 150,
          xpAmount: 150,
          xp: 150,
          reason: 'NASA Mission: Find a New Planet Expedition Completion (+150 XP)',
          category: 'positive',
          icon: '🚀',
          date: 'September 2026',
          timestamp: '2026-09-15T11:00:00.000Z',
          source: 'game',
          sourceId: 'game-nasa-mission',
          classId: 'class-4b',
          status: 'active'
        },
        {
          id: 'xp-init-student-4b-303-brain-hackers',
          studentId: 'student-4b-303',
          amount: 100,
          points: 100,
          xpAmount: 100,
          xp: 100,
          reason: 'The Brain Hackers: Mission Unlock Your Brain (+100 XP)',
          category: 'positive',
          icon: '🧠',
          date: 'September 2026',
          timestamp: '2026-09-10T14:00:00.000Z',
          source: 'game',
          sourceId: 'game-brain-hackers',
          classId: 'class-4b',
          status: 'active'
        },
        {
          id: 'xp-init-student-4b-303-good-ideas-lab',
          studentId: 'student-4b-303',
          amount: 70,
          points: 70,
          xpAmount: 70,
          xp: 70,
          reason: 'My Good Ideas Lab: Hexagonal Engineering & Biomimicry (+70 XP)',
          category: 'positive',
          icon: '💡',
          date: 'September 2026',
          timestamp: '2026-09-05T09:30:00.000Z',
          source: 'game',
          sourceId: 'game-good-ideas-lab',
          classId: 'class-4b',
          status: 'active'
        },
        {
  ...
  class MasterSchoolStore {
    ...
    getQuizzes(includeArchived = false) {
      if (this.state && Array.isArray(this.state.quizzes) && !this.state.quizzes.some(q => q.id === 'quiz-unit1-wonderland-brain')) {
        const masterQuiz = {
          id: "quiz-unit1-wonderland-brain",
          title: "🍄 Unit 1 Master Quest: Wonderland & Brain Lab",
          subtitle: "Diagnostic Progress Check & Mad Tea Party Priority Qualifier",
