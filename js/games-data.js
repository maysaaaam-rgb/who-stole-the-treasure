...
const GAMES_REGISTRY = [
  ...
  "description": "Premium 55–60 minute interactive ESL STEM adventure for Grade 4 (CEFR A1+) based on My Good Ideas Book (pp. 18–21). In the year 2045, the Future Machine has stopped. Young inventors team up with Nova & EDI across 15 pedagogical phases: emergency briefing, real problem detection, biomimicry secrets, crazy idea mixer, Da Vinci blueprint canvas, modular prototype assembly, Karl Benz improvement chamber, and the Tomorrow Science Expo.",
  "type": "game",
  ...
  "topics": [
    "The Small Inventor",
    "The Invention That Must Save Tomorrow",
  ...
  "languageFocus": "Modals of ability CAN / CAN'T + verb (It can fly, It can't sink), HAS / HAVE (It has solar wings), IS / ARE, sequencing (First, Then, Finally), problem/solution (The problem is..., My idea is...)",
  "activityMode": "Whole Class Smart Board Interactive / Team STEM Challenge",
  "interactionType": "10 Energy Conduits Power Gauge, Touch Drawing Canvas, Modular Assembly Pod, Karl Benz Test Chamber, 60s Expo Speech Timer, Voice Synthesizer & Teacher Drawer",
  ...
  "learningObjectives": [
    ...
    "Apply biomimicry principles from nature to technological problem-solving",
    "Deliver a structured 60-second capstone Expo presentation with visual slide cues and self/peer assessment"
  ],
  "teacherInstructions": "Project on Smart Board. Guide young inventors through 15 pedagogical phases: emergency briefing, real problem detection, biomimicry secrets, crazy idea mixer, Da Vinci blueprint canvas, modular prototype assembly, Karl Benz improvement chamber, and the Tomorrow Science Expo.",
  "studentInstructions": "The year is 2045! Team up with Nova & EDI, restore power to the Future Machine through 10 energy conduits, engineer a new invention, test and improve it, and present to save tomorrow!",
  ...
  "supportsProgress": true,
  "featured": true,
  "thumbnailSvg": "<svg viewBox=\"0 0 200 140\" width=\"100%\" height=\"100%\" xmlns=\"http://www.w3.org/2000/svg\"><defs><linearGradient id=\"stmThumbBg\" x1=\"0\" y1=\"0\" x2=\"1\" y2=\"1\"><stop offset=\"0%\" stop-color=\"#022c22\"/><stop offset=\"50%\" stop-color=\"#0f766e\"/><stop offset=\"100%\" stop-color=\"#0f172a\"/></linearGradient></defs><rect width=\"200\" height=\"140\" fill=\"url(#stmThumbBg)\"/><rect x=\"12\" y=\"12\" width=\"176\" height=\"116\" rx=\"12\" fill=\"#0f172a\" opacity=\"0.8\" stroke=\"#14b8a6\" stroke-width=\"2.5\" stroke-dasharray=\"6,4\"/><circle cx=\"100\" cy=\"55\" r=\"28\" fill=\"#14b8a6\" opacity=\"0.25\"/><text x=\"100\" y=\"66\" font-size=\"34\" text-anchor=\"middle\">⚡</text><rect x=\"16\" y=\"92\" width=\"168\" height=\"22\" rx=\"11\" fill=\"#14b8a6\"/><text x=\"100\" y=\"107\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"8.5\" fill=\"#042f2e\" text-anchor=\"middle\" letter-spacing=\"0.5\">SAVE TOMORROW (60 MIN)</text></svg>"
},
  {
  "id": "young-inventor",
